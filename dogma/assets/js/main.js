...
menuAddedSlash = function () {

    $ = jQuery.noConflict();

    $('.page-id-593 li.with-slash, .page-id-1085 li.with-slash, .page-id-1114 li.with-slash').each(function() {
     
        $('li.menu-services > a').attr("href","https://staging.dogmanyc.com/#our-services"); 
        $('li.menu-reviews > a').attr("href","https://staging.dogmanyc.com/#google-reviews"); 
        $('li.menu-pricing > a').attr("href","https://staging.dogmanyc.com/#pricing"); 

        $('.page-id-1085 li.menu-location > a, .page-id-1114 li.menu-location > a').attr("href","https://staging.dogmanyc.com/#contact-location"); 
        $('.page-id-1085 li.menu-contact > a, .page-id-1114 li.menu-contact > a').attr("href","https://staging.dogmanyc.com/#contact-location"); 
...
jQuery(document).ready(menuAddedSlash);
...
jQuery(document).ready(removeBlankSpace);
