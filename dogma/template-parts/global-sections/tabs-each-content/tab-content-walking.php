<?php if( have_rows('walking_tab_inner_content','option') ): ?>

    <div class="tab-inner-wrap"> 

        <?php $child_count = 0; 

        while( have_rows('walking_tab_inner_content','option') ): the_row(); 
        ...
        $child_count++;
            ...
            <div class="tab-inner-item">
                ...
                <a class="mr-link view-lb-btn" href="#lightbox-content-4-<?php echo $child_count; ?>">View Details</a>
    ...
    <div class="top-lightbox-wrapper">
        ...
        <?php $child_count = 0; 
            ...
            <div id="lightbox-content-4-<?php echo $child_count; ?>" class="popup-content-item">
